...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # The reason for this is that in ruby a += b is syntactic shorthand for a = a + b (the same goes for the other <op>= operators) 
    # which is an assignment. On the other hand << is an alias of concat() which alters the receiver in-place.
  end
